...
public class TestHDFS {
    ...
    public void init() throws URISyntaxException, IOException, InterruptedException {
        ...
        fs = FileSystem.get(new URI("hdfs://zyp-2:9000"), conf, "zyp");
    }
    ...
    public void readFile() throws IOException {
        ...
        URL url = new URL("hdfs://zyp-2:9000/start-all.sh");
    ...
    public void readFileByAPI() throws IOException {
        ...
        System.out.println(new String(bp.toByteArray()));
    }
    ...
    public void lsAll() throws IOException {
        ...
        while (listFile.hasNext()) {
            ...
            for (BlockLocation block :
                    blockLocations) {
                System.out.println("块起始偏移量: " + block.getOffset());
