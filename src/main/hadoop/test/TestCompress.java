...
public class TestCompress {
    ...
    Logger logger = LogManager.getLogger(TestCompress.class);
    ...
    public void zip(Class codecClass) throws Exception {
        ...
        //创建文件输出流,得到默认扩展名
        FileOutputStream fos = new FileOutputStream("D:\\Money\\data\\Compression\\" + codec.getDefaultExtension());
        //得到压缩流
        CompressionOutputStream zipOut = codec.createOutputStream(fos);
        IOUtils.copyBytes(new FileInputStream("D:\\Money\\data\\TemperatureSort.txt"), zipOut, 1024);
        zipOut.close();
        logger.info(codecClass.getSimpleName() + " : " + (System.currentTimeMillis() - start));
    }
