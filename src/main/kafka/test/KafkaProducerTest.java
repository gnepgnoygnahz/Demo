...
import kafka.partitioner.PersonPartitioner;
import kafka.pojo.Person;
import kafka.serializer.PersonSerializer;
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        producer.send(record, (metadata1, exception) -> {
            if (exception != null) {
                ...
                logger.info("topic:" + metadata1.topic() + ", partition:" + metadata1.partition() + ", offset:" + metadata1.offset() + ", timestamp" + metadata1.timestamp());
            }
        });
