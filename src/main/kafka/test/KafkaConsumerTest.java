...
import kafka.thread.KafkaConsumerThread;
    ...
    public static void main(String[] args) {
        ...
        try {
            while (isRunning.get()) {
                ...
                logger.info(System.currentTimeMillis() + ", 开始拉取数据=============================");
                ...
                Map<TopicPartition, Long> endOffsets = consumer.endOffsets(assignment, Duration.ofSeconds(10));
                Map<TopicPartition, Long> beginningOffsets = consumer.beginningOffsets(assignment, Duration.ofSeconds(10));
                ...
                ConsumerRecords<String, Person> records = consumer.poll(Duration.ofMillis(2000));
